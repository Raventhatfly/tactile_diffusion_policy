...
from tactile_diffusion_policy.model.common.normalizer import LinearNormalizer, SingleFieldLinearNormalizer
from tactile_diffusion_policy.common.replay_buffer import ReplayBuffer
from tactile_diffusion_policy.common.sampler import (
    SequenceSampler, get_val_mask, downsample_mask)
# from tactile_diffusion_policy.real_world.real_data_conversion import real_data_to_replay_buffer
from tactile_diffusion_policy.common.normalize_util import (
...
class PickAndPlaceDataset(BaseImageDataset):
    def __init__(self,
            shape_meta: dict,
            dataset_path: str,
            horizon=1,
        ...
        self.replay_buffer = ReplayBuffer.copy_from_path(
            dataset_path, keys=['action', 'img1', 'img2','joint_pos','joint_vel','joint_torque'])
        ...
        if n_obs_steps is not None:
            ...
            for key in rgb_keys + lowdim_keys + torque_keys:
...
def test():
    ...
    with hydra.initialize('../tactile_diffusion_policy/config'):
        cfg = hydra.compose('train_pick_and_place_workspace')
